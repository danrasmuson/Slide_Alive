...
sys.argv = ["make_ppt.py","myName.pptx","179-summer_camp_small.jpg","camp","179-summer_camp_small.jpg","camp2"]
...
while index < len(my_args):
	...
	index += 1
	my_text = ""
	while index < len(my_args) and (not my_args[index].endswith('.jpg')):
		my_text += my_args[index]
		index += 1
		my_text += " "
#	if index < len(my_args):
#		my_text     = my_args[index]
#	index += 1
